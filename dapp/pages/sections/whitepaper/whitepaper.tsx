    ...
    return (
        <>
            ...
            <div className={[styles.mono_section].join(" ")}>
                ...
                <br/>
                <p className={inter.className}>
                    In order to guarantee NYX liquidity every 24 hours all NFT holders will move
                    a small amount of NYX to the game pool, this action is call &quot;The Nyx tribute&quot;, in case of
                    not having NYX currency at that moment the token will be marked as &quot;exiled&quot; and it
            ...
            <div className={styles.mono_section}>
                ...
                <p className={inter.className}>
                    &raquo; This project uses an <a href={"https://www.alchemy.com/"} target={"_blank"}>Alchemy</a> App to connect to the Ethereum
                    blockchain.
                </p>
                <p className={inter.className}>
                    &raquo; <a href={"https://chain.link/"} target={"_blank"}>Chainlink</a> automations gather the Nyx Tribute in Nyxeum.
                </p>
                <p className={inter.className}>
